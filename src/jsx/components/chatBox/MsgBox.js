  ...
  return (
    <div className={`card chat dz-chat-history-box ${openMsg ? "" : "d-none"}`}>
      <div className="card-header chat-list-header text-center">
        <Link to="#" className="dz-chat-history-back" onClick={() => offMsg()}>
          <svg
        ...
        <div className="dropdown">
          ...
          >
            <li className="dropdown-item" onClick={() => setToggle(false)}>
              <i className="fa fa-user-circle text-primary mr-2"></i> View
              profile
            </li>
            <li className="dropdown-item" onClick={() => setToggle(false)}>
      ...
      >
        ...
        <div className="d-flex justify-content-start mb-4">
          ...
          <div className="msg_cotainer">
            I am good too, thank you for your time,jaseem sabith
        ...
        <div className="d-flex justify-content-start mb-4">
          ...
          <div className="msg_cotainer">
            I am looking for your next work
