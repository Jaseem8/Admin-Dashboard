    ...
    <>
      <div className="form-head d-flex mb-0 mb-lg-4 align-items-start">
        <div className="mr-auto d-none d-lg-block">
          ...
          <p className="mb-0">
            Welcome to Admin dashboard by jaseem sabith Ads Campaign Dashboard
          </p>
        </div>
                ...
                <div className="card-body p-4">
                  <div className="media align-items-center">
                    <div className="media-body">
                      <p className="fs-18 mb-2 wspace-no">Total Campaign</p>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="card widget-stat">
                <div className="card-body p-4">
                  <div className="media align-items-center">
                    <div className="media-body">
                      <p className="fs-18 mb-2 wspace-no">Total Audience</p>
              ...
              <div className="card" id="user-activity">
                <Tab.Container defaultActiveKey="monthly">
                  <div className="card-header pb-0 d-block d-sm-flex border-0">
                    <h3 className="fs-20 text-black mb-0">Overview</h3>
            ...
            <div className="col-xl-12">
              <div className="card">
                <div className="card-header border-0 pb-0">
                  <h3 className="fs-20 text-black mb-0">Goal Statistic</h3>
                  ...
                  <div className="row">
                    <div className="col-sm-4 mb-sm-0 mb-3 media">
                      ...
                      <div className="media-body">
                        ...
                        <span className="fs-34 text-black font-w500">73%</span>
                      </div>
                    </div>
                    <div className="col-sm-4 mb-sm-0 mb-3 media">
                      ...
                      <div className="media-body">
                        ...
                        <span className="fs-34 text-black font-w500">64%</span>
                      </div>
                    </div>
                    <div className="col-sm-4 mb-sm-0 mb-3 media">
                      ...
                      <div className="media-body">
                        ...
                        <span className="fs-34 text-black font-w500">48%</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="col-lg-4 col-xxl-12">
          <div className="row">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="media mb-4 align-items-center">
                    ...
                    <div className="media-body">
                      <span className="text-black font-w600">Instagram</span>
                  ...
                  <div className="media mb-4 align-items-center">
                    ...
                    <div className="media-body">
                      <span className="text-black font-w600">Facebook</span>
                      <div className="progress mt-3" style={{ height: 10 }}>
                        <div
                  ...
                  <div className="media align-items-center">
                    ...
                    <div className="media-body">
                      <span className="text-black font-w600">Twitter</span>
                      <div className="progress mt-3" style={{ height: 10 }}>
                        <div
            ...
            <div className="col-lg-12 col-md-6 col-xxl-6">
              <div className="card">
                <div className="card-header border-0 pb-0">
                  <h3 className="fs-20 text-black mb-0">Ads Engagement</h3>
                  <Dropdown className="ml-auto">
                    <Dropdown.Toggle
                      variant=""
            ...
            <div className="col-lg-12 col-md-12">
              <div className="card">
                <div className="card-header border-0  pb-0">
                  <h3 className="fs-20 text-black mb-0">Summary Goal</h3>
                  ...
                  <div>
                    ...
                    <div className="fs-14 mb-4">
                      <ul className="d-flex justify-content-between pb-2">
                        <li className="font-w500 text-dark">Ad Campaign</li>
                        <li>6,788/8,000</li>
                      </ul>
                      <ul className="d-flex justify-content-between pb-2">
                        <li className="font-w500 text-dark">Comments</li>
                        <li>452/800</li>
                      </ul>
                      <ul className="d-flex justify-content-between pb-2">
                        <li className="font-w500 text-dark">Likes</li>
                        <li>8,325/10,000</li>
                      </ul>
                      <ul className="d-flex justify-content-between pb-2">
                        <li className="font-w500 text-dark">Bookmarked</li>
                        <li>5,622/5,000</li>
                      </ul>
                    </div>
                  </div>
