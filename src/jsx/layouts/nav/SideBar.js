            ...
            <li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
              ...
              <ul aria-expanded="false">
                ...
                <li>
                  <Link
                    to="/campaign"
                    className={`${path === "campaign" ? "mm-active" : ""}`}
                  >
                    Campaign
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className={`${
                      path === "social-network-campaign" ? "mm-active" : ""
                    }`}
                  >
                    Social Network Campaign
                  </Link>
                ...
                <li>
                  <Link
                    to="/spendings"
                    className={`${path === "spendings" ? "mm-active" : ""}`}
                  >
                    Spendings
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    to="/new-compaign"
                    className={`${path === "new-campaign" ? "mm-active" : ""}`}
                  >
                    New Compaign
                  </Link>
                </li>
          ...
          <div className="copyright">
            <p className="fs-14 font-w200">
              <strong className="font-w400">
                Admin dashboard by jaseem sabith Dashboard
              </strong>{" "}
              Dashboard © 2023 All Rights Reserved
            </p>
            <p>
              Made by <span class="heart"></span> by Jaseem Sabith
            </p>
          </div>
        </PerfectScrollbar>
      </div>
